$(function(){
 ...
 drawCircle = function(a, b, c, d) {
   context.beginPath();
   // context.moveTo(a, b);
   context.lineTo(a + 15, b + 0);
   context.lineTo(a + 20, b + 8);
   context.lineTo(a + 10, b + 22);
   context.lineTo(a + 0, b + 16);
   context.closePath();
   context.fillStyle = d;
   return context.fill()
 };
 drawCircle2 = function(a, b, c, d) {
   context.beginPath();
   // context.moveTo(a, b);
   context.lineTo(a + 10, b + 0);
   context.lineTo(a + 20, b + 15);
   context.lineTo(a + 15, b + 20);
   context.lineTo(a + 0, b + 10);;
   context.closePath();
   context.fillStyle = d;
   return context.fill()
 };
 drawCircle3 = function(a, b, c, d) {
   context.beginPath();
   context.moveTo(a, b);
   context.lineTo(a + 10, b + 10);
   context.lineTo(a + 15, b);
   context.lineTo(a + 10, b - 10);
   context.closePath();
   context.fillStyle = d;
   return context.fill()
